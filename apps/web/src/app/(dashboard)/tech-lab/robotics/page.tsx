...
import {
  ChevronLeft, X, Bot, Factory, Sprout, HeartPulse, Rocket, Home as HomeIcon,
...
// (see roboticsTypes.ts's header: distinct from the existing AI-generated
// "New Build" flow). 24 real robots doing real jobs in the world today,
// each genuinely playable, not just described. Deliberately broad per the
// standing instruction: browse by category, click any card for the full
// picture and a real interactive simulation.
    ...
    <div className="max-w-6xl mx-auto pb-16 space-y-6">
      ...
      <div>
        ...
        <p className="text-slate-500 text-sm max-w-2xl">
          Real robots doing real jobs today -- in factories, farms, hospitals, on Mars, and in your own living room. Every one is genuinely playable: click a card to see how it actually works, then try the simulation yourself.
        </p>
      </div>
