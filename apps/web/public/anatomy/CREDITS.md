# Anatomy Explorer Image Credits

All images sourced from Wikimedia Commons. Public-domain images need no
attribution but are credited anyway as good practice; CC-BY / CC-BY-SA images
are attributed here to satisfy their license, in addition to the in-app
credit line shown under each model in `AnatomyExplorer.tsx`.

| File | Source | Author | License |
|---|---|---|---|
| `heart.png` | [Gray_internal_structure_of_heart.png](https://commons.wikimedia.org/wiki/File:Gray_internal_structure_of_heart.png) | Henry Vandyke Carter, *Gray's Anatomy* (1918) | Public Domain |
| `digestive-system.svg` | [Digestive_system_without_labels.svg](https://commons.wikimedia.org/wiki/File:Digestive_system_without_labels.svg) | Mariana Ruiz Villarreal (LadyofHats) | Public Domain |
| `respiratory-system.svg` | [Respiratory_system.svg](https://commons.wikimedia.org/wiki/File:Respiratory_system.svg) | Original by NCI, adapted by Mikael Häggström | CC BY-SA |
| `neuron.svg` | [Complete_neuron_cell_diagram_without_text.svg](https://commons.wikimedia.org/wiki/File:Complete_neuron_cell_diagram_without_text.svg) | Original by Holly Fischer, derivative by BruceBlaus | Public Domain |
| `plant-cell.svg` | [Simple_diagram_of_plant_cell_(blank).svg](https://commons.wikimedia.org/wiki/File:Simple_diagram_of_plant_cell_(blank).svg) | Vector8DIY | CC BY 4.0 |
